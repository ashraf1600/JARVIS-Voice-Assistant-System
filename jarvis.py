...
# This is speech function
def speak(text):
    """
    This function takes a string input 'text' and converts it to speech using the pyttsx3 engine.

    Args : 
        text (str): The text to be converted to speech.
    returns : 
        Voice output of the given text.    
    """
    engine.say(text)
    engine.runAndWait()
...
# speak(" Hellow My name is Ashraf . System is now online. How can I help you ? ")


# This Function recognizes the speech and convert it to text

def takeCommand():
    """
    This function listens to the user's voice input and converts it to text using the SpeechRecognition library.

    Returns:
        str: The recognized text from the user's speech. If recognition fails, returns "None".
    """
    r = sr.Recognizer()
...
while True:
    ...
    # Small talk
        ...
        speak("I was created by  Ashraful Islam, a brilliant mind!")
